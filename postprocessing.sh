...
mkdir -p wdata_Swin_Unet/logs

#python main.py --train_data_folder $traindatapath
#python main.py --split_folds --train_data_folder $traindatapath

CUBLAS_WORKSPACE_CONFIG=:4096:8 CUDA_VISIBLE_DEVICES=1 nohup timeout $timeout python postprocessing_loop.py.py --val | tee wdata_Swin_Unet/logs/fold_0.out &
